...
var _jfeaver$meditation$ReadingTime$translated = function (readingTime) {
	var tranlatedTimeOfDay = function () {
		var _p0 = readingTime.timeOfDay;
		if (_p0.ctor === 'Morning') {
			return 'Morning';
		} else {
			return 'Evening';
	...
	return {
		month: _rluiten$elm_date_extra$Date_Extra_I18n_I_en_us$monthName(readingTime.month),
		day: _elm_lang$core$Basics$toString(readingTime.day),
		timeOfDay: tranlatedTimeOfDay
	};
};
var _jfeaver$meditation$ReadingTime$decrement = function (time) {
	return time - (12 * _elm_lang$core$Time$hour);
};
var _jfeaver$meditation$ReadingTime$increment = function (time) {
	return time + (12 * _elm_lang$core$Time$hour);
};
var _jfeaver$meditation$ReadingTime$ReadingTime = F3(
	function (a, b, c) {
		return {month: a, day: b, timeOfDay: c};
	});
var _jfeaver$meditation$ReadingTime$TranslatedReadingTime = F3(
	function (a, b, c) {
		return {month: a, day: b, timeOfDay: c};
	});
var _jfeaver$meditation$ReadingTime$Evening = {ctor: 'Evening'};
var _jfeaver$meditation$ReadingTime$Morning = {ctor: 'Morning'};
var _jfeaver$meditation$ReadingTime$timeOfDay = function (time) {
	return (_elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$Date$hour(
			_elm_lang$core$Date$fromTime(time)),
		12) < 0) ? _jfeaver$meditation$ReadingTime$Morning : _jfeaver$meditation$ReadingTime$Evening;
};
var _jfeaver$meditation$ReadingTime$toggle = function (time) {
	var _p1 = _jfeaver$meditation$ReadingTime$timeOfDay(time);
	if (_p1.ctor === 'Morning') {
		return _jfeaver$meditation$ReadingTime$increment(time);
	} else {
		return _jfeaver$meditation$ReadingTime$decrement(time);
	}
};
var _jfeaver$meditation$ReadingTime$fromTime = function (time) {
	var date = _elm_lang$core$Date$fromTime(time);
	return {
		month: _elm_lang$core$Date$month(date),
		day: _elm_lang$core$Date$day(date),
		timeOfDay: _jfeaver$meditation$ReadingTime$timeOfDay(time)
	};
};

var _jfeaver$meditation$Reading$paragraph = function (readingParagraph) {
	return A2(
...
var _jfeaver$meditation$Reading$verse = function (verse) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(verse.passage)
					])),
				A2(
				_elm_lang$html$Html$p,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('citation')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
...
var _jfeaver$meditation$Reading$title = function (time) {
	var tReadingTime = _jfeaver$meditation$ReadingTime$translated(
		_jfeaver$meditation$ReadingTime$fromTime(time));
	return A3(
		_elm_lang$core$List$foldr,
		F2(
			function (x, y) {
		...
		'',
		_elm_lang$core$Native_List.fromArray(
			['Reading for: ', tReadingTime.timeOfDay, ', ', tReadingTime.month, ' ', tReadingTime.day]));
};
var _jfeaver$meditation$Reading$view = F2(
	function (time, reading) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
							_jfeaver$meditation$Reading$title(time))
						])),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
					...
					A2(_elm_lang$core$List$map, _jfeaver$meditation$Reading$verse, reading.verses)),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
						[
					...
					A2(_elm_lang$core$List$map, _jfeaver$meditation$Reading$paragraph, reading.paragraphs))
				]));
	});
var _jfeaver$meditation$Reading$none = {
	verses: _elm_lang$core$Native_List.fromArray(
		[]),
	paragraphs: _elm_lang$core$Native_List.fromArray(
		[])
};
var _jfeaver$meditation$Reading$Reading = F2(
	function (a, b) {
		return {verses: a, paragraphs: b};
	});
var _jfeaver$meditation$Reading$Verse = F2(
	function (a, b) {
		return {passage: a, reference: b};
	});
var _jfeaver$meditation$Reading$Reference = F3(
	function (a, b, c) {
		return {book: a, chapter: b, verse: c};
	});

var _jfeaver$meditation$Reading_Request$url = function (time) {
	var readingTime = _jfeaver$meditation$ReadingTime$translated(
		_jfeaver$meditation$ReadingTime$fromTime(time));
...
var _jfeaver$meditation$Reading_Request$decodeReference = A4(
	_elm_lang$core$Json_Decode$object3,
	_jfeaver$meditation$Reading$Reference,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'book', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'chapter', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'verse', _elm_lang$core$Json_Decode$string));
var _jfeaver$meditation$Reading_Request$decodeVerse = A3(
	_elm_lang$core$Json_Decode$object2,
	_jfeaver$meditation$Reading$Verse,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'passage', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'reference', _jfeaver$meditation$Reading_Request$decodeReference));
var _jfeaver$meditation$Reading_Request$decodeReading = A3(
	_elm_lang$core$Json_Decode$object2,
	_jfeaver$meditation$Reading$Reading,
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'verses',
		_elm_lang$core$Json_Decode$list(_jfeaver$meditation$Reading_Request$decodeVerse)),
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'reading',
		_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string)));
var _jfeaver$meditation$Reading_Request$get = function (time) {
	return A2(
		_evancz$elm_http$Http$get,
		_jfeaver$meditation$Reading_Request$decodeReading,
		_jfeaver$meditation$Reading_Request$url(time));
};

var _jfeaver$meditation$Meditation$initTime = 0;
var _jfeaver$meditation$Meditation$Model = F4(
	function (a, b, c, d) {
		return {time: a, reading: b, datePicker: c, isShowingTimeSelect: d};
	});
var _jfeaver$meditation$Meditation$ToggleTimeSelect = {ctor: 'ToggleTimeSelect'};
var _jfeaver$meditation$Meditation$ToggleTimeOfDay = {ctor: 'ToggleTimeOfDay'};
var _jfeaver$meditation$Meditation$ToDatePicker = F2(
	function (a, b) {
		return {ctor: 'ToDatePicker', _0: a, _1: b};
	});
var _jfeaver$meditation$Meditation$AlertReadingLoadError = F2(
	function (a, b) {
		return {ctor: 'AlertReadingLoadError', _0: a, _1: b};
	});
var _jfeaver$meditation$Meditation$SetReading = function (a) {
	return {ctor: 'SetReading', _0: a};
};
var _jfeaver$meditation$Meditation$SetTime = F2(
	function (a, b) {
		return {ctor: 'SetTime', _0: a, _1: b};
	});
var _jfeaver$meditation$Meditation$init = function () {
	var _p0 = _Bogdanp$elm_datepicker$DatePicker$init(_Bogdanp$elm_datepicker$DatePicker$defaultSettings);
	var datePicker$ = _p0._0;
	var datePickerCmd = _p0._1;
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{time: _jfeaver$meditation$Meditation$initTime, reading: _jfeaver$meditation$Reading$none, datePicker: datePicker$, isShowingTimeSelect: false},
		_elm_lang$core$Native_List.fromArray(
			[
				A3(
				_elm_lang$core$Task$perform,
				_elm_lang$core$Basics$identity,
				_jfeaver$meditation$Meditation$SetTime(_jfeaver$meditation$Meditation$initTime),
				_elm_lang$core$Time$now),
				A2(
				_elm_lang$core$Platform_Cmd$map,
				_jfeaver$meditation$Meditation$ToDatePicker(true),
				datePickerCmd)
			]));
}();
var _jfeaver$meditation$Meditation$setTime = F2(
	function (previousTime, newTime) {
		return A3(
			_elm_lang$core$Task$perform,
			_elm_lang$core$Basics$identity,
			_jfeaver$meditation$Meditation$SetTime(previousTime),
			_elm_lang$core$Task$succeed(newTime));
	});
var _jfeaver$meditation$Meditation$datePickerFollowUp = F3(
	function (doSetTime, mDate, model) {
		if (doSetTime) {
			var _p1 = mDate;
			if (_p1.ctor === 'Nothing') {
				return _elm_lang$core$Native_List.fromArray(
				...
				return _elm_lang$core$Native_List.fromArray(
					[
						A2(
						_jfeaver$meditation$Meditation$setTime,
						model.time,
						_elm_lang$core$Date$toTime(_p1._0))
					]);
			}
		} else {
			return _elm_lang$core$Native_List.fromArray(
...
var _jfeaver$meditation$Meditation$update = F2(
	function (msg, model) {
		var _p2 = msg;
		switch (_p2.ctor) {
			case 'SetTime':
				...
				return {
					...
					_1: A3(
						_elm_lang$core$Task$perform,
						_jfeaver$meditation$Meditation$AlertReadingLoadError(_p2._0),
						_jfeaver$meditation$Meditation$SetReading,
						_jfeaver$meditation$Reading_Request$get(_p3))
				};
			case 'SetReading':
				return {
					ctor: '_Tuple2',
			...
			case 'AlertReadingLoadError':
				var _p5 = _p2._0;
				var settings = _Bogdanp$elm_datepicker$DatePicker$defaultSettings;
				var mDate = _elm_lang$core$Native_Utils.eq(_p5, _jfeaver$meditation$Meditation$initTime) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(
				...
				var datePickerCmd = _p4._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{time: _p5, datePicker: datePicker}),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							_elm_lang$core$Platform_Cmd$map,
							_jfeaver$meditation$Meditation$ToDatePicker(false),
							datePickerCmd)
						]));
			case 'ToggleTimeOfDay':
				return {
					...
					_1: A2(
						_jfeaver$meditation$Meditation$setTime,
						model.time,
						_jfeaver$meditation$ReadingTime$toggle(model.time))
				};
			case 'ToDatePicker':
				var _p7 = _p2._0;
				var _p6 = A2(_Bogdanp$elm_datepicker$DatePicker$update, _p2._1, model.datePicker);
				var datePicker$ = _p6._0;
				var datePickerCmd = _p6._1;
				var mDate = _p6._2;
				var commands = A3(_jfeaver$meditation$Meditation$datePickerFollowUp, _p7, mDate, model);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
					...
					A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								_elm_lang$core$Platform_Cmd$map,
								_jfeaver$meditation$Meditation$ToDatePicker(_p7),
								datePickerCmd)
							])));
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							isShowingTimeSelect: _elm_lang$core$Basics$not(model.isShowingTimeSelect)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _jfeaver$meditation$Meditation$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_jfeaver$meditation$Meditation$ToggleTimeSelect)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('time-select'),
								_elm_lang$html$Html_Attributes$hidden(
								_elm_lang$core$Basics$not(model.isShowingTimeSelect))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Events$onClick(_jfeaver$meditation$Meditation$ToggleTimeOfDay)
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('Toggle')
									])),
								A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(
							_jfeaver$meditation$Meditation$SetTime,
							model.time,
							_jfeaver$meditation$ReadingTime$increment(model.time)))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('>')
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(
							_jfeaver$meditation$Meditation$SetTime,
							model.time,
							_jfeaver$meditation$ReadingTime$decrement(model.time)))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('<')
					])),
				A2(_jfeaver$meditation$Reading$view, model.time, model.reading)
			]));
};

var _jfeaver$meditation$MeditationMain$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: _jfeaver$meditation$Meditation$init,
			update: _jfeaver$meditation$Meditation$update,
			subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none),
			view: _jfeaver$meditation$Meditation$view
		})
};

var Elm = {};
Elm['MeditationMain'] = Elm['MeditationMain'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['MeditationMain'], 'MeditationMain', typeof _jfeaver$meditation$MeditationMain$main === 'undefined' ? null : _jfeaver$meditation$MeditationMain$main);
