...
var _jfeaver$meditation$ReadingTime$month = function (_p0) {
	return _rluiten$elm_date_extra$Date_Extra_I18n_I_en_us$monthName(
		_rluiten$elm_date_extra$Date_Extra_Core$intToMonth(
			function (_) {
				return _.month;
			}(_p0)));
};
var _jfeaver$meditation$ReadingTime$timeOfDay = function (readingTime) {
	var _p1 = readingTime.timeOfDay;
	if (_p1.ctor === 'Morning') {
		return 'Morning';
	} else {
		return 'Evening';
...
var _jfeaver$meditation$ReadingTime$ReadingTime = F3(
	function (a, b, c) {
		return {timeOfDay: a, month: b, day: c};
	});
var _jfeaver$meditation$ReadingTime$Evening = {ctor: 'Evening'};
var _jfeaver$meditation$ReadingTime$Morning = {ctor: 'Morning'};
var _jfeaver$meditation$ReadingTime$model = {timeOfDay: _jfeaver$meditation$ReadingTime$Morning, month: 1, day: 19};
var _jfeaver$meditation$ReadingTime$fromDate = function (date) {
	var timeOfDay = (_elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$Date$hour(date),
		12) < 0) ? _jfeaver$meditation$ReadingTime$Morning : _jfeaver$meditation$ReadingTime$Evening;
	return {
		timeOfDay: timeOfDay,
		month: _rluiten$elm_date_extra$Date_Extra_Core$monthToInt(
			_elm_lang$core$Date$month(date)),
		day: _elm_lang$core$Date$day(date)
	};
};
var _jfeaver$meditation$ReadingTime$now = A2(
	_elm_lang$core$Task$map,
	function (date) {
		return _jfeaver$meditation$ReadingTime$fromDate(date);
	},
	_elm_lang$core$Date$now);

var _jfeaver$meditation$Reading$url = function (readingTime) {
	return A3(
		_elm_lang$core$List$foldr,
		F2(
			function (x, y) {
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_jfeaver$meditation$ReadingTime$month(readingTime)),
				'_',
				A3(
				_elm_lang$core$String$padLeft,
				2,
				_elm_lang$core$Native_Utils.chr(' '),
				_elm_lang$core$Basics$toString(readingTime.day)),
				'_',
				_elm_lang$core$String$toLower(
				_jfeaver$meditation$ReadingTime$timeOfDay(readingTime)),
				'.json'
			]));
};
var _jfeaver$meditation$Reading$model = {
...
var _jfeaver$meditation$Reading$decodeReference = A4(
...
var _jfeaver$meditation$Reading$decodeVerse = A3(
	_elm_lang$core$Json_Decode$object2,
	_jfeaver$meditation$Reading$Verse,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'passage', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'reference', _jfeaver$meditation$Reading$decodeReference));
var _jfeaver$meditation$Reading$decodeReading = A3(
	_elm_lang$core$Json_Decode$object2,
	_jfeaver$meditation$Reading$Reading,
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'verses',
		_elm_lang$core$Json_Decode$list(_jfeaver$meditation$Reading$decodeVerse)),
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'reading',
		_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string)));
var _jfeaver$meditation$Reading$request = function (readingTime) {
	return A2(
		_evancz$elm_http$Http$get,
		_jfeaver$meditation$Reading$decodeReading,
		_jfeaver$meditation$Reading$url(readingTime));
};

var _jfeaver$meditation$MorningAndEvening$paragraph = function (readingParagraph) {
	return A2(
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(readingVerse.passage)
					])),
				A2(
				_elm_lang$html$Html$p,
				_elm_lang$core$Native_List.fromArray(
...
var _jfeaver$meditation$MorningAndEvening$title = function (readingTime) {
	return A3(
		_elm_lang$core$List$foldr,
		F2(
			function (x, y) {
...
var _jfeaver$meditation$MorningAndEvening$view = function (model) {
	return A2(
...
var _jfeaver$meditation$MorningAndEvening$Model = F2(
	function (a, b) {
		return {readingTime: a, reading: b};
	});
var _jfeaver$meditation$MorningAndEvening$SetReading = function (a) {
	return {ctor: 'SetReading', _0: a};
};
var _jfeaver$meditation$MorningAndEvening$ReadingRequestFailed = function (a) {
	return {ctor: 'ReadingRequestFailed', _0: a};
};
var _jfeaver$meditation$MorningAndEvening$getReading = function (readingTime) {
	return A3(
		_elm_lang$core$Task$perform,
		_jfeaver$meditation$MorningAndEvening$ReadingRequestFailed,
		_jfeaver$meditation$MorningAndEvening$SetReading,
		_jfeaver$meditation$Reading$request(readingTime));
};
var _jfeaver$meditation$MorningAndEvening$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'SetReadingTime':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{readingTime: _p1}),
					_1: _jfeaver$meditation$MorningAndEvening$getReading(_p1)
				};
			case 'ReadingRequestFailed':
				var _p2 = A2(
...
var _jfeaver$meditation$MorningAndEvening$SetReadingTime = function (a) {
	return {ctor: 'SetReadingTime', _0: a};
};
var _jfeaver$meditation$MorningAndEvening$initReadingTime = A3(_elm_lang$core$Task$perform, _jfeaver$meditation$MorningAndEvening$SetReadingTime, _jfeaver$meditation$MorningAndEvening$SetReadingTime, _jfeaver$meditation$ReadingTime$now);
var _jfeaver$meditation$MorningAndEvening$init = {ctor: '_Tuple2', _0: _jfeaver$meditation$MorningAndEvening$model, _1: _jfeaver$meditation$MorningAndEvening$initReadingTime};

var _jfeaver$meditation$MorningAndEveningMain$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: _jfeaver$meditation$MorningAndEvening$init,
			view: _jfeaver$meditation$MorningAndEvening$view,
			update: _jfeaver$meditation$MorningAndEvening$update,
			subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none)
		})
};

var Elm = {};
Elm['MorningAndEveningMain'] = Elm['MorningAndEveningMain'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['MorningAndEveningMain'], 'MorningAndEveningMain', typeof _jfeaver$meditation$MorningAndEveningMain$main === 'undefined' ? null : _jfeaver$meditation$MorningAndEveningMain$main);
